...
`;
  ...
  await nukeResumeSpawnCtx.run(["tmux", "set-option", "-t", tmuxSession, "history-limit", "50000"]);
...
`;
  ...
  await newAgentSpawnCtx.run(["tmux", "set-option", "-t", tmuxSession, "history-limit", "50000"]);
