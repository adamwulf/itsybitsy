...
*(The kernel write-deny mechanism and the pid/epoch adoption check are the intended contract being integrated on `agent/sandbox-exec-feature`; treat them as the target design, not a shipped/gated guarantee — see `docs/SANDBOX-ROLLOUT.md`.)*
