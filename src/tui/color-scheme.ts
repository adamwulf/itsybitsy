...
export function getStateColors(): Record<string, string> {
  if (colorScheme === "light") {
    return {
      ...
      compacting: MAGENTA, rate_limited: RED, api_error: RED, api_terms: RED, api_safeguard: RED, stopped: DIM_GRAY,
  ...
  return {
    ...
    compacting: BRIGHT_MAGENTA, rate_limited: RED, api_error: RED, api_terms: RED, api_safeguard: RED, stopped: DIM_GRAY,
    merging: YELLOW, restarting: YELLOW, op_stuck: RED, unknown: WHITE,
  };
}
