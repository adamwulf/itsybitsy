...
- **Agents spawned before this change:** there is no migration code. Retire pre-change codex/fugu and agy agents and start fresh ones with `ib new-agent`; do not resume or rehire them.
